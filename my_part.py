...
def tk_part():
    ...
    def draw_menu():
        ...
        fact_button.place(x=20, y=370, height= 80, width=365)
        # кнопка со змейкой
        ...
        orel_button = Button(text='ОРЕЛ ИЛИ РЕШКА?', font=('Franklin Gothic Heavy', 25), fg ='#640', bg = '#ffe500') #fg='#04427d', bg= '#a6d0f7'
        orel_button.place(x=415, y=250, height = 80, width=365)
        # кнопка с платформером
        img = ImageTk.PhotoImage(file='pictures\plateaser2.png')
        ...
        # кнопка со змейкой
        img2 = ImageTk.PhotoImage(file='pictures\snaketeaser.png')
    ...
    def facts():
        clear()
        mainfact_label = Label(text = 'ИНТЕРЕСНЫЙ ФАКТ!', font=('Franklin Gothic Heavy', 24), fg='#640', bg= '#ffad08')
        ...
        label_fact = Message(text= fact_text, font=('Franklin Gothic Heavy', 23), width=700, fg= '#640', bg= '#f9fac0')
        label_fact.place(x=30, y= 90)
        more_button = Button(text="Подробнее...", font=("Franklin Gothic Heavy", 28), fg= '#640', bg= '#ffad08', command=callback)
    ...
    def clicker():
        ...
        label_title.place(width=800, height=50, x= 10, y= 90)
        def usual_button():
            global points
            points += 1
            if points %3 == 0:
        ...
        slow_b = Button(text="Ме-е-едленно...", font=("Franklin Gothic Heavy", 35), bg="#c204bb", fg="white", command= slow_button)
        ...
        comp_b = Button(text="БОЛЬШАЯ КНОПКА!", font=("Franklin Gothic Heavy", 50), width=20, bg="#8c0488", fg="white", command= compliment_button)
        ...
        null_b = Button(text="Полный ноль!", font=("Franklin Gothic Heavy", 35), bg="white", fg="#6042d6", command= null_button)
        ...
        hundred_b = Button(text="+100!!!", font=("Franklin Gothic Heavy", 35), bg="#491e82", fg="#ad8adb", command= hundred_button)
        ...
        bd_b = Button(text="????", font=("Franklin Gothic Heavy", 35), bg="#321e82", fg="white", command= blue_death_button)
    ...
    def snake():
        ...
        def move(snake, food):
            ...
            if (direction == 'down'):  # если заданное направление вниз, то увеличиваем Y
                y += SPACE_SIZE
            elif (direction == 'up'):  # если зааднное движение вверх, то уменьшаем y
                y -= SPACE_SIZE
